      ...
      <div className="mx-[5%] bg-[#FAFAFA] p-[3%] max-[850px]:px-[10%] rounded-[20px]">
        <div className="bg-white px-[10%] py-[3%] shadow-lg rounded-[20px]">
          <div className="flex justify-between  ">
            <div className="flex  items-center w-[30%] max-[1000px]:w-[35%]">
              <img
                className="h-[250px] w-[250px] rounded-[50%] object-cover shadow-lg max-[1245px]:h-[200px] max-[1245px]:w-[200px] max-[1000px]:h-[150px] max-[1000px]:w-[150px]  "
                src={userProfile}
                alt=""
              />
            </div>
            <div className="w-[60%]">
              <div className="flex justify-between items-center">
                ...
                <div className=" flex justify-between w-[40%] max-[700px]:hidden">
                  <button className="bg-[#8735C8] font-QSemi text-white px-[5%] py-[1%] rounded-[10px] shadow-md ">
                    Follow
                  </button>
                  <button className="bg-gray-400 font-QSemi text-white px-[5%] py-[1%] rounded-[10px] shadow-md ">
                    Message
                  </button>
                </div>
